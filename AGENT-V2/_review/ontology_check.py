...
check(has(SKILL, "two-step is MANDATORY")
      ...
      and has(SKILL, "HARD BUDGET"),
      "[routing] SKILL.md: the mandatory cross-object two-step (with the "
      "smaller-side ferry direction + 4-query hard budget) is gone (PROD "
      "issue #3, 2026-08-21) — 'BlackRock in convertible bonds' either "
      "gets refused with a menu or loops 40 queries again")
