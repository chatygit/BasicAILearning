...
| `git history: AGENT-V2/views/_docs/_diagnostics-results.md (retired 2026-09-17)` | Answers to the pre-fix diagnostic queries, plus the scope rules governing view changes | Live document. |
