...
SELECT
    ...
    D.TOTAL_DEMAND AS TOTAL_DEMAND,
    D.TOTAL_ALLOCATION AS TOTAL_ALLOCATION,
    CASE WHEN D.DEAL_SIZE > 0
         THEN ROUND(D.TOTAL_DEMAND / D.DEAL_SIZE, 2)
         END AS SUBSCRIPTION_RATIO,
...
FROM (
    SELECT ODT.DEAL_ID,
           ...
           MAX(OC.TOTAL_DEMAND) AS TOTAL_DEMAND,
           MAX(OC.TOTAL_ALLOCATION) AS TOTAL_ALLOCATION
