...
LEFT JOIN (
    SELECT
        ...
        CASE
            WHEN COUNT(S.SYNDICATE_MEMBER_NAME) > 0
                AND SUM(CASE WHEN REGEXP_LIKE(S.SYNDICATE_MEMBER_NAME, '^CITI', 'i')
                              AND NOT REGEXP_LIKE(S.SYNDICATE_MEMBER_NAME, '^(CITIZ|CITICC)', 'i')
                             THEN 0 ELSE 1 END) = 0
            THEN 'SOLO'
            ELSE 'SHARED'
        END AS DEAL_SHARING_TYPE
