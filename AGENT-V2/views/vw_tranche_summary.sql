...
SELECT
    ...
    ROUND(TT.TOTAL_FEE, 6) AS TOTAL_FEE,
    ROUND(TT.UNDERWRITING_FEE, 6) AS UNDERWRITING_FEE,
    ROUND(TT.MANAGEMENT_FEE, 6) AS MANAGEMENT_FEES,
    ROUND(TT.SELLING_CONCESSION_FEE, 6) AS SELLING_CONCESSION_FEE,
    ROUND(TT.PRAEPICIUM_FEE, 6) AS PRAECIPIUM_FEES,
    ROUND(TT.RETAIL_UNDERWRITING_FEE, 6) AS RETAIL_UW_FEE,
    ...
    ROUND(TT.GROSS_SPREAD_PER_FEE, 6) AS GROSS_SPREAD_PER_FEE,
    ROUND(TT.DESIGNATION_FEE, 6) AS DESIGNATION_FEE,
...
SELECT
    ...
    ROUND(ODT.TOTAL_FEE, 6) AS TOTAL_FEE,
    ROUND(ODT.UNDERWRITING_FEE, 6) AS UNDERWRITING_FEE,
    ROUND(ODT.MANAGEMENT_FEES, 6) AS MANAGEMENT_FEES,
    ROUND(ODT.SELLING_CONSESSION_FEE, 6) AS SELLING_CONCESSION_FEE,
    ROUND(ODT.PRAECIPIUM_FEES, 6) AS PRAECIPIUM_FEES,
    ROUND(ODT.RETAIL_UW_FEE, 6) AS RETAIL_UW_FEE,
