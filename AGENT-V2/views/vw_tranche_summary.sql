...
SELECT
    ...
    CAST(NULL AS NUMBER) AS TOTAL_FEE,
    CAST(NULL AS NUMBER) AS UNDERWRITING_FEE,
    CAST(NULL AS NUMBER) AS MANAGEMENT_FEES,
    CAST(NULL AS NUMBER) AS SELLING_CONCESSION_FEE,
    CAST(NULL AS NUMBER) AS PRAECIPIUM_FEES,
    CAST(NULL AS NUMBER) AS RETAIL_UW_FEE,
    CAST(NULL AS TIMESTAMP(6)) AS ANNOUNCEMENT_TS,
    CAST(NULL AS TIMESTAMP(6)) AS ISSUE_TS,
    CAST(NULL AS TIMESTAMP(6)) AS TRADE_TS,
